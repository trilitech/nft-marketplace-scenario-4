...
contract NFTMarketplace is ERC721URIStorage {
    ...
    //This will return all the NFTs created in the marketplace
    ...
    function getAllListedNFTs() public view returns (ListedToken[] memory) {
        ...
        ListedToken[] memory tokens = new ListedToken[](listedNumber);
        uint currentIndex = 0;
        for(uint i=0;i<nftCount;i++) {
            ListedToken storage currentItem = idToListedToken[i];
    ...
    function executeSale(uint256 tokenId) public payable {
        ...
        // approve(address(this), tokenId); // wtf is that xD
